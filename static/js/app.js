...
// render the navbar into the menuheader
...
// check to see if the submit button is pressed, if it is, stop the event from refreshing the page, and call search city
...
// make search information not appear until they submit a city_name
